...
## 1.7.1 — CSP-safe multilingual corrective release
...
## 1.7.1 — Community security hardening
...
## 1.7.1 — Enterprise reliability portal UX
...
- Updated all visible/runtime package version references to 1.7.1.
...
- Per release policy, L0–L6 must still be rerun against the deployed 1.7.1 build before new performance claims are published.
