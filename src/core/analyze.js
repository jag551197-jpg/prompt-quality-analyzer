...
const REASON_LABELS={
  ...
  'citation-fabrication':'CITATION_FABRICATION','weak-grounding':'WEAK_GROUNDING','no-abstention':'NO_ABSTENTION','no-citations':'NO_CITATIONS'
};
